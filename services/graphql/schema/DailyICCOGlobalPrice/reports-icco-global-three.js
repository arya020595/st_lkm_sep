          ...
          body: [
            ...
            ...(() => {
                ...
                table.push([
                  ...
                  },
                  {
                    text:
                      (indexedPrices["USD"] &&
                        indexedPrices["USD"].price &&
                        formatCurrency(indexedPrices["USD"].price)) ||
                      "-",
                    alignment: "center",
                  },
                  {
                  ...
                  {
                    text: rmTonne ? formatCurrency(rmTonne) : "-",
                    alignment: "center",
                  },
                ]);
              ...
              table.push([
                ...
                {
                  text: stats.iccoUSD ? formatCurrency(stats.iccoUSD) : "-",
                  fillColor: "#f0f0f0",
                  alignment: "center",
                },
                {
                ...
                {
                  text: stats.rmTonne ? formatCurrency(stats.rmTonne) : "-",
                  fillColor: "#f0f0f0",
                  alignment: "center",
                },
              ]);
              ...
              table.push([
                ...
                },
                {
                  text: averageStats.iccoUSD
                    ? formatCurrency(averageStats.iccoUSD)
                    : "-",
                  alignment: "center",
                  bold: true,
                },
                ...
                },
                {
                  text: averageStats.rmTonne
                    ? formatCurrency(averageStats.rmTonne, 2)
                    : "-",
                  alignment: "center",
                  bold: true,
                },
            ...
            ...(() => {
              ...
              [...new Array(diffYear)].forEach((_, yearIndex) => {
                ...
                do {
                  ...
                  // let priceStats = {};
                  // for (const price of prices) {
                  //   priceStats[price.currency] = price.price;
                  //   if (price.price) {
                  //     stats[price.currency].push(price.price);
                  //   }
                  //   if (price.exchangeRate) {
                  //     stats.exchangeRates.push(price.exchangeRate);
                  //     priceStats["exchangeRates"] = price.exchangeRate;
                  //   }
                  // }
              ...
              //   {
              //     text: averageStats.iccoEX
              //       ? formatCurrency(averageStats.iccoEX, 0)
              //       : "-",
              //     bold: true,
              //     alignment: "center",
              //   },
              //   {
              //     text: averageStats.rmTonne
              //       ? formatCurrency(averageStats.rmTonne)
              //       : "-",
              //     bold: true,
              //     alignment: "center",
              //   },
...
const generateMonthlyInternationalCocoaPriceReport = async (
  ...
  const docDefinition = {
    ...
    content: [
      {
        text: `Monthly International Cocoa Price - ${params.category}`,
        bold: true,
        alignment: "center",
        fontSize: BASE_FONT_SIZE + 4,
      },
        ...
        table: {
          ...
          body: [
            ...
            ...(() => {
              ...
              do {
                ...
                table.push([
                  ...
                  },
                  {
                    text:
                      formatNumber(
                        lodash.round(indexedPrices.terminal, 0),
                        0,
                      ) || "-",
                    alignment: "center",
                  },
              ...
              const averageTotalTerminal = lodash.round(totalTerminal / 12, 2);

              // console.log(averageTotalTerminal);
              ...
              table.push([
                ...
                },
                {
                  text: averageTotalTerminal
                    ? formatNumber(averageTotalTerminal, 2)
                    : "-",
                  alignment: "center",
                  bold: true,
                  // text: stats.londonTerminal
...
const generateYearlyInternationalCocoaPriceReport = async (
  ...
  const docDefinition = {
    ...
    content: [
      {
        text: `Yearly International Cocoa Price - ${params.category}`,
        bold: true,
        alignment: "center",
        fontSize: BASE_FONT_SIZE + 4,
      },
            ...
            ...(() => {
              ...
              do {
                  ...
                  if (params.category === "London") {
                    ...
                    if (price.sgEx > 0) {
                      ...
                      indexedPrices.exchangeRatesPerMonthPerYear.push({
                        date: price.date,
                        exc: price.sgEx,
                        terminal: price.sgEx * price.sgAvg,
                      });
                    }
                  }
                }
                ...
                for (let i = 1; i <= 12; i++) {
                  ...
                  tmpAvg.push(lodash.round(sum / count, 4));
                ...
                table.push([
                  ...
                  {
                    text: formatNumber(lodash.round(terminal, 4), 2) || "-",
                    alignment: "center",
                  },
                ]);
