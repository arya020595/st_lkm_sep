...
const resolvers = {
  Query: {
    allBasicCocoaStatisticDomesticProductions: async (
      self,
      params,
      context,
    ) => {
    ...
    allBasicCocoaStatisticDomesticProductionsTokenized: async (
      self,
      params,
      context,
    ) => {
    ...
    countBasicCocoaStatisticDomesticProductions: async (
      self,
      params,
      context,
    ) => {
  ...
  Mutation: {
    createBasicCocoaStatisticDomesticProduction: async (
      self,
      params,
      context,
    ) => {
      ...
      const payload = {
        _id: uuidv4(),
        affectedCollectionName: "BasicCocoaStatisticDomesticProductions",
    ...
    updateBasicCocoaStatisticDomesticProduction: async (
      self,
      params,
      context,
    ) => {
    ...
    deleteBasicCocoaStatisticDomesticProduction: async (
      self,
      params,
      context,
    ) => {
    ...
    createBasicCocoaStatisticDomesticProductionTokenized: async (
      self,
      params,
      context,
    ) => {
    ...
    updateBasicCocoaStatisticDomesticProductionTokenized: async (
      self,
      params,
      context,
    ) => {
    ...
    deleteBasicCocoaStatisticDomesticProductionTokenized: async (
      self,
      params,
      context,
    ) => {
  ...
  BasicCocoaStatisticDomesticProduction: {
