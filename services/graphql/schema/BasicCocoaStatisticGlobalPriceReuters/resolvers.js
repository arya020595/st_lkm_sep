...
const resolvers = {
  Query: {
    allBasicCocoaStatisticGlobalPriceReuters: async (self, params, context) => {
    ...
    countBasicCocoaStatisticGlobalPriceReuters: async (
      self,
      params,
      context,
    ) => {
  ...
  Mutation: {
    createBasicCocoaStatisticGlobalPriceReuters: async (
      self,
      params,
      context,
    ) => {
      ...
      const payload = {
        _id: uuidv4(),
        affectedCollectionName: "GlobalReutersPrices",
      ...
      await context.collection("GlobalReutersPrices").insertOne(newData);
      return "success";
    },
    updateBasicCocoaStatisticGlobalPriceReuters: async (
      self,
      params,
      context,
    ) => {
      ...
      const found = await context.collection("GlobalReutersPrices").findOne({
        _id: params._id,
      });
      const payload = {
        _id: uuidv4(),
    ...
    deleteBasicCocoaStatisticGlobalPriceReuters: async (
      self,
      params,
      context,
    ) => {
