...
const resolvers = {
  Query: {
    allUnstructuredDocumentIncentives: async (self, params, context) => {
  ...
  Mutation: {
    createUnstructuredDocumentIncentives: async (self, params, context) => {
    ...
    updateUnstructuredDocumentIncentives: async (self, params, context) => {
      assertValidSession(context.activeSession);
      if (!context.activeSession.User) {
        throw new Error("Session End. Please re-login");
      }
      ...
      await context.collection("UnstructuredDocumentIncentives").updateOne(
        {
          _id: params._id,
        },
        {
    ...
    deleteUnstructuredDocumentIncentives: async (self, params, context) => {
      assertValidSession(context.activeSession);
      if (!context.activeSession.User) {
        throw new Error("Session End. Please re-login");
      }
