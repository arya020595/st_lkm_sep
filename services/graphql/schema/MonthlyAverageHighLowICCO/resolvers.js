...
const resolvers = {
  Query: {
    allMonthlyAverageHighLowICCOPrices: async (self, params, context) => {
    ...
    allMonthlyAverageHighLowICCOPricesTokenized: async (self, params, context) => {
  ...
  Mutation: {
    createMonthlyAverageHighLowICCOPrice: async (self, params, context) => {
      ...
      const payload = {
        _id: uuidv4(),
        affectedCollectionName: "MonthlyAverageHighLowICCO",
      ...
      await context.collection("MonthlyAverageHighLowICCO").insertOne(newData);
      return "success";
    },
    updateMonthlyAverageHighLowICCOPrice: async (self, params, context) => {
      assertValidSession(context.activeSession);
      if (!context.activeSession.User) {
        throw new Error("Session End. Please re-login");
      }
      ...
      await context.collection("MonthlyAverageHighLowICCO").updateOne(
        {
          _id: params._id,
        },
        {
    ...
    deleteMonthlyAverageHighLowICCOPrice: async (self, params, context) => {
      assertValidSession(context.activeSession);
      if (!context.activeSession.User) {
        throw new Error("Session End. Please re-login");
      }
    ...
    createMonthlyAverageHighLowICCOPriceTokenized: async (Self, params, context) => {
      assertValidSession(context.activeSession);
      if (!context.activeSession.User) {
        throw new Error("Session End. Please re-login");
      }
    ...
    updateMonthlyAverageHighLowICCOPriceTokenized: async (self, params, context) => {
      assertValidSession(context.activeSession);
      if (!context.activeSession.User) {
        throw new Error("Session End. Please re-login");
      }
    ...
    deleteMonthlyAverageHighLowICCOPriceTokenized: async (self, params, context) => {
      assertValidSession(context.activeSession);
      if (!context.activeSession.User) {
        throw new Error("Session End. Please re-login");
      }
  ...
  MonthlyAverageHighLowICCOPrice: {
