...
const REPORT = gql`
  mutation generateSemenanjungSmallholderReport(
    $title: String!
    $code: String!
    $year: Int!
  ) {
...
const EstateCensus = () => {
  ...
  const [generateSemenanjungSmallholderReport] = useMutation(REPORT);
  // ------------------------------------------------------------------------
            ...
            onSubmit={async e => {
              ...
              try {
                ...
                if (typeof reportMutation === "string") {
                  let result = await generateSemenanjungSmallholderReport({
                    variables: {
                      ...filters,
                      code: reportMutation,
                      title: filters.type,
                  ...
                  const reportUrl =
                    result.data.generateSemenanjungSmallholderReport +
                    "?t=" +
