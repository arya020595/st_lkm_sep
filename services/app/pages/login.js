...
const CHECK_USER_PASSWORD = gql`
  mutation checkEmployeeIdAndPassword($tokenizedInput: String!) {
    checkEmployeeIdAndPasswordTokenized(tokenizedInput: $tokenizedInput)
  }
`;
const Page = props => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (result.data.checkEmployeeIdAndPasswordTokenized) {
        ...
        const encryptedData =
          result.data?.checkEmployeeIdAndPasswordTokenized || "";
