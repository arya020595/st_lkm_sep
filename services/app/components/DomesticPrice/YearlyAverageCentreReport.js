...
const REPORT = gql`
  mutation generateYearlyAverageCentreReportForDomesticCocoaPricesWithGrade(
    $fromYearIds: [String!]!
    $toYearIds: [String!]!
    $centreIds: [String!]!
    $gradeIds: [String!]!
...
const Report = () => {
  ...
  const [generateYearlyAverageCentreReportForDomesticCocoaPricesWithGrade] =
    useMutation(REPORT);
    ...
    <div className="w-full py-4 flex flex-col md:flex-row">
      <form
        onSubmit={async e => {
          ...
          try {
            let result =
              await generateYearlyAverageCentreReportForDomesticCocoaPricesWithGrade({
                variables: {
                  ...filters,
                },
              });
