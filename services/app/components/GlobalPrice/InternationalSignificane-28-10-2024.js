...
const QUERY = gql`
  query listQueries($year: String, $years: [String!]) {
    allInternationalSignificancePrices(year: $year, years: $years) {
      _id
      year
      month
      Source {
...
const CREATE_INTERNATIONAL_SIGNIFICANCE = gql`
  mutation createInternationalSignificancePrice(
    $year: Int!
    $month: Int
    $sourceId: String!
    $londonFuture: Float
    ...
    createInternationalSignificancePrice(
      ...
      londonFuture: $londonFuture
      newYorkFuture: $newYorkFuture
    )
  }
`;

const UPDATE_INTERNATIONAL_SIGNIFICANCE = gql`
  mutation updateInternationalSignificancePrice(
    $_id: String!
    $year: Int!
    $month: Int
    $sourceId: String!
...
const DELETE_INTERNATIONAL_SIGNIFICANCE = gql`
  mutation deleteInternationalSignificancePrice($_id: String!) {
    deleteInternationalSignificancePrice(_id: $_id)
  }
`;
