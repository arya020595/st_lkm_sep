...
const QUERY = gql`
  query listQueries(
    ...
    countSabahSmallholderPangkalanData
...
const Smallholder = () => {
  ...
  let sabahSmallholderPangkalanData = [];
  if (data?.sabahSmallholderPangkalanData) {
    sabahSmallholderPangkalanData = data.sabahSmallholderPangkalanData;
  }
  // console.log({ sabahSmallholderPangkalanData });
  let countSabahSmallholderPangkalanData =
    data?.countSabahSmallholderPangkalanData || 0;
  ...
  let pageCount = useMemo(() => {
    if (!countSabahSmallholderPangkalanData) return 1;
    return Math.ceil(countSabahSmallholderPangkalanData / pageSize);
  }, [countSabahSmallholderPangkalanData, pageSize]);
  ...
  return (
    <div>
      ...
      <Table
        loading={loading}
        columns={columns}
        data={sabahSmallholderPangkalanData}
        withoutHeader={true}
