...
const REPORT = gql`
  mutation generateGlobalTradeDataCocoaProductByCountryReport(
    $type: String
    $product: String
    $fromYear: String
    $toYear: String
...
const Report = () => {
  ...
  const [generateGlobalTradeDataCocoaProductByCountryReport] =
    useMutation(REPORT);
    ...
    <div className="w-full py-4 flex flex-col md:flex-row">
      <form
        onSubmit={async e => {
          ...
          try {
            let result =
              await generateGlobalTradeDataCocoaProductByCountryReport({
                variables: {
                  ...filters,
                },
              });
            const reportUrl =
              result.data.generateGlobalTradeDataCocoaProductByCountryReport +
              "?t=" +
