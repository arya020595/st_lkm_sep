...
const QUERY = gql`
  query listQueries($year: String!, $years: [String!]) {
    allBasicCocoaStatisticGlobalGrindings(year: $year, years: $years) {
      _id
      year
      CountryRegion {
        _id
...
const CREATE_BCS_GLOBAL_GRINDING = gql`
  mutation createBasicCocoaStatisticGlobalGrinding(
    $year: String
...
const UPDATE_BCS_GLOBAL_GRINDING = gql`
  mutation updateBasicCocoaStatisticGlobalGrinding(
    $_id: String!
    $year: String
    $countryRegionId: String
    $countryId: String
...
const DELETE_BCS_GLOBAL_GRINDING = gql`
  mutation deleteBasicCocoaStatisticGlobalGrinding($_id: String!) {
    deleteBasicCocoaStatisticGlobalGrinding(_id: $_id)
  }
`;
    ...
    <div>
      ...
      <div className="flex mt-4">
        ...
        <p className="text-md font-bold mx-4">
          {data?.countBasicCocoaStatisticGlobalGrindings || 0}
        </p>
      </div>
    </div>
  );
