...
const LIST_QUERIES = gql`
  query listQueries {
    allGlobalCountryProfileConsumings {
      _id
      Country {
        _id
        name
...
const CREATE_CONSUMING_PROFILE = gql`
  mutation createGlobalCountryProfileConsuming(
    $countryId: String
...
const UPDATE_CONSUMING_PROFILE = gql`
  mutation updateGlobalCountryProfileConsuming(
    $_id: String!
    $countryId: String
    $countryRegionId: String
    $cultivatedArea: String
...
const DELETE_CONSUMING_PROFILE = gql`
  mutation deleteGlobalCountryProfileConsuming($_id: String!) {
    deleteGlobalCountryProfileConsuming(_id: $_id)
  }
`;

const CONSUMNG_COUNTRY_PROFILE_TRADE_QUERY = gql`
  query allGlobalCountryProfileConsumingTradeByCountryId($countryId: String!) {
    allGlobalCountryProfileConsumingTradeByCountryId(countryId: $countryId) {
      _id
      GlobalSITCProduct {
        _id
        code
...
const CREATE_CONSUMING_TRADE = gql`
  mutation createGlobalCountryProfileConsumingTrade(
    $countryId: String
    $countryRegionId: String
...
const UPDATE_CONSUMING_TRADE = gql`
  mutation updateGlobalCountryProfileConsumingTrade(
    $_id: String!
    $countryId: String
    $countryRegionId: String
    $globalSITCProductId: String
...
const DELETE_CONSUMING_TRADE = gql`
  mutation deleteGlobalCountryProfileConsumingTrade($_id: String!) {
    deleteGlobalCountryProfileConsumingTrade(_id: $_id)
  }
`;

const CONSUMING_FILE_QUERY = gql`
  query countryConsumingFile($countryId: String!) {
    countryConsumingFile(countryId: $countryId) {
      _id
      countryId
      type
      description
...
const CREATE_UPLOAD_FILE = gql`
  mutation createCountryProfileConsumingFile(
    $countryId: String
    $type: String
    $description: String
    $fileUrl: String
...
const UPDATE_UPLOAD_FILE = gql`
  mutation updateCountryProfileConsumingFile(
    $_id: String!
    $countryId: String
    $type: String
    $description: String
...
const DELETE_UPLOAD_FILE = gql`
  mutation deleteCountryProfileConsumingFile($_id: String!) {
    deleteCountryProfileConsumingFile(_id: $_id)
  }
`;
    ...
    <div>
          ...
          <Tabs
            ...
            <TabPanel>
              ...
              <Table
                ...
                data={
                  tradeData?.allGlobalCountryProfileConsumingTradeByCountryId ||
                  []
                }
                withoutHeader={true}
                onAdd={e => {
            ...
            <TabPanel>
              ...
              <Table
                ...
                data={uploadData?.countryConsumingFile || []}
                withoutHeader={true}
                onAdd={e => {
                  if (e) e.preventDefault();
                  setUploadFormData({
      ...
      <div className="flex mt-4">
        ...
        <p className="text-md font-bold mx-4">
          {data?.countGlobalCountryProfileConsumings || 0}
        </p>
      </div>
    </div>
  );
